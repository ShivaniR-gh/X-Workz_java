public class WeaponRunner {
    public static void main(String[] args) {
        ...
        weapon2.name = "Revolver";
        weapon2.type = "Firearm";
        ...
        weapon5.weaponId = 105;
        weapon5.name = "Shotgun";
        weapon5.type = "Firearm";
        weapon5.material = "Metal";
        ...
        weapon6.weaponId = 106;
        weapon6.name = "Crossbow";
        weapon6.type = "Ranged";
        weapon6.material = "Carbon Fiber";
        ...
        weapon7.weaponId = 107;
        weapon7.name = "Spear";
        weapon7.type = "Melee";
        weapon7.material = "Bamboo";
        ...
        weapon8.weaponId = 108;
        weapon8.name = "AK-47";
        weapon8.type = "Automatic";
        ...
        weapon9.weaponId = 109;
        weapon9.name = "Knife";
        weapon9.type = "Blade";
        weapon9.material = "Stainless Steel";
        weapon9.isLicensed = false;
